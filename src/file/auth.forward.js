        ...
        try {
            await client.invoke(
                new Api.messages.ForwardMessages({
                    ...
                    silent: true, // Add this line to forward without sender name
                    dropAuthor: true, // Add this line to forward without sender name
                    // dropMediaCaptions: true, // Add this line to forward without caption name may be used in future and mat be for caption
                })
            );
